...
- [kreuzwerker/envsec](https://github.com/kreuzwerker/envsec) ([v1.2.2](https://github.com/kreuzwerker/envsec/releases/tag/v1.2.2), today) - Encrypted environment variables via AWS KMS
- [kreuzwerker/envplate](https://github.com/kreuzwerker/envplate) ([v1.0.3](https://github.com/kreuzwerker/envplate/releases/tag/v1.0.3), today) - Docker-friendly trivial templating for configuration files using environment keys
- [kreuzwerker/awsu](https://github.com/kreuzwerker/awsu) ([v2.3.10](https://github.com/kreuzwerker/awsu/releases/tag/v2.3.10), today) - Enhanced account switching for AWS, supports Yubikey as MFA source
- [git-chglog/git-chglog](https://github.com/git-chglog/git-chglog) ([v0.15.4](https://github.com/git-chglog/git-chglog/releases/tag/v0.15.4), today) - CHANGELOG generator implemented in Go (Golang).
