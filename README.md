...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v8.5.3](https://github.com/maxritter/pilot-shell/releases/tag/v8.5.3), today) - The Claude Code engineering platform: spec-driven planning, enforced TDD, persistent memory, and quality hooks. Make Claude Code production-ready.
