...
- [git-chglog/git-chglog](https://github.com/git-chglog/git-chglog) ([v0.11.2](https://github.com/git-chglog/git-chglog/releases/tag/v0.11.2), today) - CHANGELOG generator implemented in Go (Golang).
