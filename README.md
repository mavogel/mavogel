...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) - The professional development environment for Claude Code. Tests enforced, context preserved, quality automated. (1 month ago)

#### 🔭 Latest releases I've contributed to

- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v7.5.5](https://github.com/maxritter/pilot-shell/releases/tag/v7.5.5), today) - The professional development environment for Claude Code. Tests enforced, context preserved, quality automated.
