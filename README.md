...
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.67](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.67), 1 day ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.42](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.42), 1 day ago) - The corresponding projen template for the AWS CDK Construct
...
- [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) - Drop in a screenshot and convert it to clean HTML/Tailwind/JS code (4 days ago)
- [udondan/cfn-teleport](https://github.com/udondan/cfn-teleport) - A command-line tool which can move CloudFormation resources between stacks (6 days ago)
