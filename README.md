...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v8.4.0](https://github.com/maxritter/pilot-shell/releases/tag/v8.4.0), today) - Make Claude Code production-ready — spec-driven plans, enforced quality gates, persistent knowledge
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.457](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.457), today) - The corresponding projen template for the AWS CDK Construct
