...
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.56.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.56.0), 2 days ago) - Terraform AWS provider
...
- [superwerker/superwerker](https://github.com/superwerker/superwerker) ([v0.12.6](https://github.com/superwerker/superwerker/releases/tag/v0.12.6), 4 days ago) - Open-source solution to automate the setup of an AWS Cloud environment with prescriptive best practices. 
