...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v4.5.19](https://github.com/maxritter/claude-codepro/releases/tag/v4.5.19), 1 day ago) - Professional Development Environment for Claude Code with Endless Mode, Spec-Driven Development, TDD, LSP, Persistent Memory, Semantic Search, Quality Hooks and Modular Rules
...
- [caarlos0/telegram-summarizer](https://github.com/caarlos0/telegram-summarizer) - Telegram bot to transcribe and summarize audio messages (2 days ago)
- [agentsmd/agents.md](https://github.com/agentsmd/agents.md) - AGENTS.md — a simple, open format for guiding coding agents (5 days ago)
- [partly-notes/waffle](https://github.com/partly-notes/waffle) - CLI utility to perform AWS Well Architected Framework reviews with the help of Amazon Bedrock infrastructure and WAF questions analysis (5 days ago)
