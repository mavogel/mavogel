...
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.52](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.52), 4 days ago) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
...
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.320](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.320), 3 weeks ago) - An opinionated way to secure your AWS root email boxes
...
- [modelcontextprotocol/registry](https://github.com/modelcontextprotocol/registry) - A community driven registry service for Model Context Protocol (MCP) servers. (3 days ago)
