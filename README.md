...
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.47.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.47.0), 2 days ago) - Terraform AWS provider
- [kreuzwerker/terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ([v2.13.0](https://github.com/kreuzwerker/terraform-provider-docker/releases/tag/v2.13.0), 4 days ago) - Terraform Docker provider
...
- [superwerker/superwerker](https://github.com/superwerker/superwerker) ([v0.12.4](https://github.com/superwerker/superwerker/releases/tag/v0.12.4), 4 weeks ago) - Open-source solution to automate the setup of an AWS Cloud environment with prescriptive best practices. 
