...
- [MV-Consulting/.github](https://github.com/MV-Consulting/.github) -  (5 days ago)

#### 🔭 Latest releases I've contributed to

- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.364](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.364), 1 day ago) - The corresponding projen template for the AWS CDK Construct
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.228](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.228), 1 day ago) - An opinionated way to secure your AWS root email boxes
...
- [aws-samples/fleet-management-on-amazon-eks-workshop](https://github.com/aws-samples/fleet-management-on-amazon-eks-workshop) -  (3 days ago)
