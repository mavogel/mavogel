...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v2.3.5](https://github.com/maxritter/claude-codepro/releases/tag/v2.3.5), today) - Claude CodePro is a Professional System for Building Quality Code with Claude Code (CC). Start shipping systematically with Spec-Driven Development, Skills, TDD, Semantic Search, Persistent Memory, Context Management, Quality Hooks, Modular Rules System, and much more 🚀
