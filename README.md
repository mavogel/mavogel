...
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.166](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.166), today) - An opinionated way to secure your AWS root email boxes
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.317](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.317), today) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.308](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.308), 1 day ago) - The corresponding projen template for the AWS CDK Construct
...
- [caprover/caprover](https://github.com/caprover/caprover) - Scalable PaaS (automated Docker&#43;nginx) - aka Heroku on Steroids (5 days ago)
