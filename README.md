...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v5.1.0](https://github.com/maxritter/claude-codepro/releases/tag/v5.1.0), today) - Production-grade AI development for Claude Code. TDD enforced. Quality automated. Ship with confidence.
