...
- [goreleaser/acceptance-tests](https://github.com/goreleaser/acceptance-tests) - Acceptance tests setup et al for GoReleaser. (today)
...
- [kreuzwerker/pre-commit-golang](https://github.com/kreuzwerker/pre-commit-golang) - kreuzwerker pre-commit hooks for golang (2 weeks ago)
...
- [superwerker/superwerker](https://github.com/superwerker/superwerker) ([v0.12.3](https://github.com/superwerker/superwerker/releases/tag/v0.12.3), 1 day ago) - Open-source solution to automate the setup of an AWS Cloud environment with prescriptive best practices. 
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.39.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.39.0), 4 days ago) - Terraform AWS provider
