...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) - Claude Code is powerful. Pilot makes it reliable. Tests enforced. Context preserved. Quality automated. ☑️ (2 weeks ago)
...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) ([v6.2.1](https://github.com/maxritter/claude-pilot/releases/tag/v6.2.1), 1 day ago) - Claude Code is powerful. Pilot makes it reliable. Tests enforced. Context preserved. Quality automated. ☑️
...
- [antonpk1/excalidraw-mcp-app](https://github.com/antonpk1/excalidraw-mcp-app) - Excalidraw MCP App Server — hand-drawn diagrams for Claude (2 days ago)
...
- [strands-agents/agent-sop](https://github.com/strands-agents/agent-sop) - Natural language workflows that enable AI agents to perform complex, multi-step tasks with consistency and reliability. (5 days ago)
