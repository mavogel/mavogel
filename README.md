...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v9.12.1](https://github.com/maxritter/pilot-shell/releases/tag/v9.12.1), 1 day ago) - How real engineers run Claude Code and Codex: spec-driven planning, enforced TDD, persistent memory, and quality enforcement on all levels. Make your agents production-ready.
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.336](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.336), 6 days ago) - An opinionated way to secure your AWS root email boxes
