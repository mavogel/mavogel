...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v9.2.4](https://github.com/maxritter/pilot-shell/releases/tag/v9.2.4), today) - How real engineers run Claude Code and Codex: spec-driven planning, enforced TDD, persistent memory, and quality enforcement on all levels. Make your agents production-ready.
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.89](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.89), today) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
