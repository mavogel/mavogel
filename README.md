...
- [mavogel/go-ssh-forward](https://github.com/mavogel/go-ssh-forward) ([v0.1.7](https://github.com/mavogel/go-ssh-forward/releases/tag/v0.1.7), today) - A simple library to establish a forward via a jump host in go
- [MV-Consulting/mvc-projen](https://github.com/MV-Consulting/mvc-projen) ([v0.0.6](https://github.com/MV-Consulting/mvc-projen/releases/tag/v0.0.6), today) - Projen templates for our projects
...
- [coleam00/local-ai-packaged](https://github.com/coleam00/local-ai-packaged) - Run all your local AI together in one package - Ollama, Supabase, n8n, Open WebUI, and more! (today)
