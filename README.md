...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v3.0.14](https://github.com/maxritter/claude-codepro/releases/tag/v3.0.14), 1 day ago) - Claude CodePro is a Professional Development Environment for Claude Code (CC). Start shipping systematically with Spec-Driven Development, Skills, TDD, Semantic Search, Persistent Memory, Context Management, Quality Hooks, Modular Rules System, and much more 🚀
