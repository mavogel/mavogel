...
- [antonbabenko/pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) - pre-commit git hooks to take care of Terraform configurations (4 weeks ago)
...
- [superwerker/superwerker](https://github.com/superwerker/superwerker) ([v0.12.0](https://github.com/superwerker/superwerker/releases/tag/v0.12.0), 1 day ago) - Open-source solution to automate the setup of an AWS Cloud environment with prescriptive best practices. 
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.36.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.36.0), 1 day ago) - Terraform AWS provider
