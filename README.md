...
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.215](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.215), today) - An opinionated way to secure your AWS root email boxes
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.353](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.353), today) - The corresponding projen template for the AWS CDK Construct
...
- [egoist/awesome-esbuild](https://github.com/egoist/awesome-esbuild) - A curated list of awesome esbuild resources (today)
