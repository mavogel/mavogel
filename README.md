...
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.33.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.33.0), 1 day ago) - Terraform AWS provider
- [git-chglog/git-chglog](https://github.com/git-chglog/git-chglog) ([v0.11.2](https://github.com/git-chglog/git-chglog/releases/tag/v0.11.2), 5 days ago) - CHANGELOG generator implemented in Go (Golang).
