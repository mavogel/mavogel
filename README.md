...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v3.3.1](https://github.com/maxritter/claude-codepro/releases/tag/v3.3.1), today) - Professional Development Environment for Claude Code with Spec-Driven Workflow, TDD, LSP, Cross-Session Memory, Semantic Search, Quality Hooks and Modular Rules System 🛠️
