...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) - Claude Code, Done Right. The structure Claude needs to be reliable. ✔️ (1 week ago)
...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) ([v6.0.0](https://github.com/maxritter/claude-pilot/releases/tag/v6.0.0), today) - Claude Code, Done Right. The structure Claude needs to be reliable. ✔️
