...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v2.1.10](https://github.com/maxritter/claude-codepro/releases/tag/v2.1.10), 1 day ago) - Claude CodePro is a Professional System for Building Quality Code with Claude Code (CC). Start shipping systematically with Spec-Driven Development, Skills, TDD, Semantic Search, Persistent Memory, Context Management, Quality Hooks, Modular Rules System, and much more 🚀
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.450](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.450), 6 days ago) - The corresponding projen template for the AWS CDK Construct
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.326](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.326), 6 days ago) - An opinionated way to secure your AWS root email boxes
