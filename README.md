...
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.63](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.63), today) - An opinionated way to secure your AWS root email boxes
...
- [commitizen-tools/commitizen](https://github.com/commitizen-tools/commitizen) - Create committing rules for projects :rocket: auto bump versions :arrow_up: and auto changelog generation :open_file_folder:  (today)
