...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v8.0.1](https://github.com/maxritter/pilot-shell/releases/tag/v8.0.1), today) - Make Claude Code production-ready — spec-driven plans, enforced tests, persistent knowledge
...
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.69](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.69), 2 days ago) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
