...
- [kkeles/awsug-hugo](https://github.com/kkeles/awsug-hugo) - Website Template for AWS User Groups (2 days ago)
...
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.112](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.112), 1 day ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.79](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.79), 5 days ago) - The corresponding projen template for the AWS CDK Construct
...
- [gethinode/hinode](https://github.com/gethinode/hinode) - A clean documentation and blog theme for your Hugo site based on Bootstrap 5 (3 days ago)
