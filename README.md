...
- [mavogel/cdk-vscode-server](https://github.com/mavogel/cdk-vscode-server) ([v0.0.112](https://github.com/mavogel/cdk-vscode-server/releases/tag/v0.0.112), 1 day ago) - Set up your own VSCode Server on AWS in under 10 minutes
- [mavogel/mvc-projen](https://github.com/mavogel/mvc-projen) ([v0.0.45](https://github.com/mavogel/mvc-projen/releases/tag/v0.0.45), 5 days ago) - Projen templates for our projects
- [mavogel/awscdk-rootmail](https://github.com/mavogel/awscdk-rootmail) ([v0.1.5](https://github.com/mavogel/awscdk-rootmail/releases/tag/v0.1.5), 1 week ago) - An opinionated way to secure your AWS root email boxes
