...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v8.4.1](https://github.com/maxritter/pilot-shell/releases/tag/v8.4.1), today) - The Claude Code engineering platform: spec-driven planning, enforced TDD, persistent memory, and quality hooks. Make Claude Code production-ready.
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.76](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.76), 1 day ago) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
...
- [achankra/peh-course](https://github.com/achankra/peh-course) - Course to launch Platform Engineering Handbook (2 days ago)
- [cschnidr/KiroLink](https://github.com/cschnidr/KiroLink) - A self-hosted Telegram bridge for Kiro CLI. Message your bot, your Linux home server runs Kiro, the answer comes back to your phone. (4 days ago)
