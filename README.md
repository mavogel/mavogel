...
- [mavogel/cdk-hugo-pipeline](https://github.com/mavogel/cdk-hugo-pipeline) ([v0.0.24](https://github.com/mavogel/cdk-hugo-pipeline/releases/tag/v0.0.24), 3 days ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
...
- [aws-cli-tools/delete-bucket](https://github.com/aws-cli-tools/delete-bucket) - Delete S3 buckets the easy way (4 days ago)
- [jestjs/jest](https://github.com/jestjs/jest) - Delightful JavaScript Testing. (6 days ago)
