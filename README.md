...
- [mavogel/s3-cdk-assets-bootstrap](https://github.com/mavogel/s3-cdk-assets-bootstrap) - Bootstraps your AWS accounts with S3 asset buckets per region and a release bucket. Additionally creates IAM roles for GitHub Actions OICD roles. (1 week ago)
...
- [mavogel/awscdk-rootmail](https://github.com/mavogel/awscdk-rootmail) ([v0.1.5](https://github.com/mavogel/awscdk-rootmail/releases/tag/v0.1.5), 1 day ago) - An opinionated way to secure your AWS root email boxes
- [mavogel/cdk-vscode-server](https://github.com/mavogel/cdk-vscode-server) ([v0.0.107](https://github.com/mavogel/cdk-vscode-server/releases/tag/v0.0.107), 1 day ago) - Set up your own VSCode Server on AWS in under 10 minutes
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v11.0.5](https://github.com/maxritter/pilot-shell/releases/tag/v11.0.5), 2 days ago) - Professional context and harness engineering for Claude Code and OpenAI Codex. Build production-grade software with spec-driven development, TDD, persistent memory, quality gates, code intelligence, human oversight, and end-to-end verification.
- [mavogel/mvc-projen](https://github.com/mavogel/mvc-projen) ([v0.0.42](https://github.com/mavogel/mvc-projen/releases/tag/v0.0.42), 4 days ago) - Projen templates for our projects
...
- [maxritter/open-claude-design](https://github.com/maxritter/open-claude-design) - Claude Design in Claude Code, Codex, Cursor, and 20&#43; agents. Designs come from your real components, tokens, and states; approved revisions sync back. (2 weeks ago)
- [openai/plugins](https://github.com/openai/plugins) - OpenAI Plugins (4 weeks ago)
