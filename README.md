...
- [kreuzwerker/envplate](https://github.com/kreuzwerker/envplate) ([v1.0.3](https://github.com/kreuzwerker/envplate/releases/tag/v1.0.3), 4 months ago) - Docker-friendly trivial templating for configuration files using environment keys
