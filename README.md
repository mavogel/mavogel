...
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.72.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.72.0), 2 days ago) - Terraform AWS provider
- [kreuzwerker/m1-terraform-provider-helper](https://github.com/kreuzwerker/m1-terraform-provider-helper) ([0.3.1](https://github.com/kreuzwerker/m1-terraform-provider-helper/releases/tag/0.3.1), 4 days ago) - CLI to support with downloading and compiling terraform providers for Mac with M1 chip
