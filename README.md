...
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.121](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.121), 1 day ago) - The corresponding projen template for the AWS CDK Construct
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.157](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.157), 1 day ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
...
- [aripalo/aws-cdk-github-oidc](https://github.com/aripalo/aws-cdk-github-oidc) - CDK constructs to use OpenID Connect for authenticating your Github Action workflow with AWS IAM (2 days ago)
- [JimmyDqv/serverless-handbook](https://github.com/JimmyDqv/serverless-handbook) -  (4 days ago)
