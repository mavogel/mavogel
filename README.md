...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v9.1.3](https://github.com/maxritter/pilot-shell/releases/tag/v9.1.3), 4 days ago) - How real engineers run Claude Code and Codex: spec-driven planning, enforced TDD, persistent memory, and quality enforcement on all levels. Make your agents production-ready.
...
- [johnalanwoods/maintained-modern-unix](https://github.com/johnalanwoods/maintained-modern-unix) - A collection of modern/faster/greater alternatives to common UNIX commands, which is maintained. (2 weeks ago)
