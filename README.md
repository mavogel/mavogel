...
- [kreuzwerker/pre-commit-golang](https://github.com/kreuzwerker/pre-commit-golang) - kreuzwerker pre-commit hooks for golang (2 days ago)
- [antonbabenko/pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) - pre-commit git hooks to take care of Terraform configurations (3 days ago)
...
- [superwerker/superwerker](https://github.com/superwerker/superwerker) ([v0.12.2](https://github.com/superwerker/superwerker/releases/tag/v0.12.2), 4 days ago) - Open-source solution to automate the setup of an AWS Cloud environment with prescriptive best practices. 
