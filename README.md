...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) ([v6.10.2](https://github.com/maxritter/claude-pilot/releases/tag/v6.10.2), 1 day ago) - Claude Code is powerful. Pilot makes it reliable. Start a task, grab a coffee, come back to production-grade code. Tests enforced. Context preserved. Quality automated.
...
- [fastapi/fastapi](https://github.com/fastapi/fastapi) - FastAPI framework, high performance, easy to learn, fast to code, ready for production (3 days ago)
- [maxritter/claude-pilot-demo](https://github.com/maxritter/claude-pilot-demo) - Demo: Full-Stack project built entirely by AI using Claude Pilot — zero manual code edits (3 days ago)
- [jacob-bd/notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) -  (3 days ago)
- [steipete/summarize](https://github.com/steipete/summarize) - Point at any URL/YouTube/Podcast or file. Get the gist. CLI and Chrome Extension. (1 week ago)
