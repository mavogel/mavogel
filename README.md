...
- [antonbabenko/pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ([v1.64.1](https://github.com/antonbabenko/pre-commit-terraform/releases/tag/v1.64.1), 1 week ago) - pre-commit git hooks to take care of Terraform configurations
- [lovoo/goka](https://github.com/lovoo/goka) ([v1.1.2](https://github.com/lovoo/goka/releases/tag/v1.1.2), 2 weeks ago) - Goka is a compact yet powerful distributed stream processing library for Apache Kafka written in Go.
