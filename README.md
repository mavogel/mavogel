...
- [MV-Consulting/awscdk-rootmail](https://github.com/MV-Consulting/awscdk-rootmail) ([v0.0.247](https://github.com/MV-Consulting/awscdk-rootmail/releases/tag/v0.0.247), today) - An opinionated way to secure your AWS root email boxes
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.377](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.377), today) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.382](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.382), 1 day ago) - The corresponding projen template for the AWS CDK Construct
...
- [stephanstapel/ZUGFeRD-csharp](https://github.com/stephanstapel/ZUGFeRD-csharp) - C# assembly for creating and reading ZUGFeRD invoices (3 days ago)
- [aws/aws-pdk](https://github.com/aws/aws-pdk) - The AWS PDK provides building blocks for common patterns together with development tools to manage and build your projects. (4 days ago)
- [jnsahaj/lumen](https://github.com/jnsahaj/lumen) - Instant AI Git Commit message, Git changes summary from the CLI (no API key required) (5 days ago)
