...
- [git-chglog/git-chglog](https://github.com/git-chglog/git-chglog) ([v0.12.0](https://github.com/git-chglog/git-chglog/releases/tag/v0.12.0), today) - CHANGELOG generator implemented in Go (Golang).
