...
- [mavogel/projen-cdk-hugo-pipeline](https://github.com/mavogel/projen-cdk-hugo-pipeline) ([v0.0.1](https://github.com/mavogel/projen-cdk-hugo-pipeline/releases/tag/v0.0.1), 2 days ago) - The corresponding projen template for the AWS CDK Construct
- [mavogel/cdk-hugo-pipeline](https://github.com/mavogel/cdk-hugo-pipeline) ([v0.0.25](https://github.com/mavogel/cdk-hugo-pipeline/releases/tag/v0.0.25), 2 days ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
...
- [nusserstudios/tailbliss](https://github.com/nusserstudios/tailbliss) - TailBliss is a Hugo Starter theme built on TailwindCSS 3, and Alpine.JS. (4 days ago)
- [aws-samples/cdk-integ-tests-sample](https://github.com/aws-samples/cdk-integ-tests-sample) -  (6 days ago)
