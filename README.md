...
- [maxritter/claude-pilot](https://github.com/maxritter/claude-pilot) ([v6.5.7](https://github.com/maxritter/claude-pilot/releases/tag/v6.5.7), 1 day ago) - Claude Code is powerful. Pilot makes it reliable. Start a task, grab a coffee, come back to production-grade code. Tests enforced. Context preserved. Quality automated.
...
- [aws-samples/hardeneks](https://github.com/aws-samples/hardeneks) - Runs checks to see if an EKS cluster follows EKS Best Practices. (4 days ago)
- [aws-samples/appmod-blueprints](https://github.com/aws-samples/appmod-blueprints) -  (4 days ago)
- [anthropics/claude-code-monitoring-guide](https://github.com/anthropics/claude-code-monitoring-guide) -  (4 days ago)
- [jlia0/tinyclaw](https://github.com/jlia0/tinyclaw) - TinyClaw is a team of personal agents that collaborate with each other (5 days ago)
- [ryoppippi/ccusage](https://github.com/ryoppippi/ccusage) - A CLI tool for analyzing Claude Code/Codex CLI usage from local JSONL files. (5 days ago)
