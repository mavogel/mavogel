...
- [awslabs/landing-zone-accelerator-on-aws](https://github.com/awslabs/landing-zone-accelerator-on-aws) ([v1.12.5](https://github.com/awslabs/landing-zone-accelerator-on-aws/releases/tag/v1.12.5), 1 day ago) - Deploy a multi-account cloud foundation to support highly-regulated workloads and complex compliance requirements.
...
- [evsor/kubetoolkit](https://github.com/evsor/kubetoolkit) - A collection of tools to debug Kubernetes clusters (3 days ago)
- [csantanapr/awesome-learn](https://github.com/csantanapr/awesome-learn) - Cloud Native Learning Path (3 days ago)
- [arben-adm/mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking) -  (6 days ago)
