...
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.47](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.47), 1 day ago) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
...
- [contains-studio/agents](https://github.com/contains-studio/agents) - sharing current agents in use (2 days ago)
