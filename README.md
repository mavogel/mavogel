...
- [git-chglog/git-chglog](https://github.com/git-chglog/git-chglog) ([v0.11.1](https://github.com/git-chglog/git-chglog/releases/tag/v0.11.1), today) - CHANGELOG generator implemented in Go (Golang).
