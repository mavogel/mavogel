...
- [mavogel/cdk-hugo-pipeline](https://github.com/mavogel/cdk-hugo-pipeline) ([v0.0.22](https://github.com/mavogel/cdk-hugo-pipeline/releases/tag/v0.0.22), 3 days ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
...
- [dannysteenman/aws-toolbox](https://github.com/dannysteenman/aws-toolbox) - A collection of tools and python scripts to automate repetitive tasks on AWS Cloud (6 days ago)
- [cdklabs/cdk-stacksets](https://github.com/cdklabs/cdk-stacksets) -  (6 days ago)
