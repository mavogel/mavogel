...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v9.8.0](https://github.com/maxritter/pilot-shell/releases/tag/v9.8.0), today) - How real engineers run Claude Code and Codex: spec-driven planning, enforced TDD, persistent memory, and quality enforcement on all levels. Make your agents production-ready.
