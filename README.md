...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([dev-329d248-20260126](https://github.com/maxritter/claude-codepro/releases/tag/dev-329d248-20260126), today) - Production-Grade Development Environment for Claude Code. Quality automated. Context optimized. Testing enforced. Ship with confidence. 💪
...
- [aws-controllers-k8s/code-generator](https://github.com/aws-controllers-k8s/code-generator) - Code generator for AWS Controllers for Kubernetes (today)
