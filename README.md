...
- [MV-Consulting/cdk-vscode-server](https://github.com/MV-Consulting/cdk-vscode-server) ([v0.0.52](https://github.com/MV-Consulting/cdk-vscode-server/releases/tag/v0.0.52), 2 days ago) - Set up your own VSCode Server on AWS in under 10 minutes ⌛️
...
- [modelcontextprotocol/registry](https://github.com/modelcontextprotocol/registry) - A community driven registry service for Model Context Protocol (MCP) servers. (1 day ago)
