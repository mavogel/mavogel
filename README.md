...
- [MV-Consulting/projen-cdk-hugo-pipeline](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline) ([v0.0.6](https://github.com/MV-Consulting/projen-cdk-hugo-pipeline/releases/tag/v0.0.6), 4 days ago) - The corresponding projen template for the AWS CDK Construct
- [MV-Consulting/cdk-hugo-pipeline](https://github.com/MV-Consulting/cdk-hugo-pipeline) ([v0.0.30](https://github.com/MV-Consulting/cdk-hugo-pipeline/releases/tag/v0.0.30), 5 days ago) - This is an AWS CDK Construct for building and deploying Hugo Static websites with an all-in-one infrastructure-as-code deployment on AWS
...
- [romannurik/SlidesCodeHighlighter](https://github.com/romannurik/SlidesCodeHighlighter) - A little web app that helps you copy&#43;paste syntax-highlighted code into slide decks. (4 days ago)
