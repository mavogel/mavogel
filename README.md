...
- [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) ([v7.5.1](https://github.com/maxritter/pilot-shell/releases/tag/v7.5.1), today) - The professional development environment for Claude Code. Claude Code is powerful. Pilot Shell makes it reliable. Start a task, grab a coffee, come back to production-grade code. Tests enforced. Context preserved. Quality automated.
