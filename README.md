...
- [maxritter/claude-codepro](https://github.com/maxritter/claude-codepro) ([v4.2.4](https://github.com/maxritter/claude-codepro/releases/tag/v4.2.4), 1 day ago) - Professional Development Environment for Claude Code with Endless Mode, Spec-Driven Development, TDD, LSP, Persistent Memory, Semantic Search, Quality Hooks and Modular Rules 🛠️
...
- [agentsmd/agents.md](https://github.com/agentsmd/agents.md) - AGENTS.md — a simple, open format for guiding coding agents (1 day ago)
- [partly-notes/waffle](https://github.com/partly-notes/waffle) - CLI utility to perform AWS Well Architected Framework reviews with the help of Amazon Bedrock infrastructure and WAF questions analysis (1 day ago)
- [cablate/mcp-google-map](https://github.com/cablate/mcp-google-map) - A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities. (1 day ago)
...
- [DataDog/pathfinding.cloud](https://github.com/DataDog/pathfinding.cloud) - An AWS IAM Privilege Escalation Path Library (5 days ago)
